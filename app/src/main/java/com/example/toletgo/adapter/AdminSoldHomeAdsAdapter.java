...
public class AdminSoldHomeAdsAdapter extends RecyclerView.Adapter<AdminSoldHomeAdsAdapter.ViewHolder> {

    private Context context;
    private ArrayList<HomePostShowModel> dataSets;

    public AdminSoldHomeAdsAdapter(Context context, ArrayList<HomePostShowModel> dataSets) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.buttonSold.setText(context.getResources().getString(R.string.live));
        holder.buttonSold.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dataRef.child(dataSets.get(position).getPostLocation()).child("postSold").setValue(false);
            }
        });
