 ...
 */
public class UserLiveHomeAds extends Fragment {
    ...
    public UserLiveHomeAds(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_user_live_home_ads, container, false);
