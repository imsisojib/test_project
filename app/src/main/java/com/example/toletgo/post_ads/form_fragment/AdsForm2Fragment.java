...
public class AdsForm2Fragment extends Fragment implements View.OnClickListener {
    ...
    private TextInputEditText etHolding,etRentPrice;
    ...
    private void replaceAdsForm1() {
        AdsForm1Fragment adsForm1Fragment = new AdsForm1Fragment(getActivity(),mBundle.getBoolean("userMode"));
    ...
    public void onClick(View v) {
        ...
        if (v.getId()==R.id.bt_go_next){
            String price,holding,bed,bath,kitchen,front,balcony;
