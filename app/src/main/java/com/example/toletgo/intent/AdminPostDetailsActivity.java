...
import com.example.toletgo.dialog_fragment.OwnerDetailsDialog;
import com.example.toletgo.R;
import com.example.toletgo.adapter.ImageSliderAdminAdapter;
...
public class AdminPostDetailsActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_post_details);
        ...
        buttonDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DialogFragment dialog = OwnerDetailsDialog.newInstance();
                OwnerDetailsDialog.setValues(detailsModel.getDetailsHomeName(), detailsModel.getDetailsOwnerName(),
                        detailsModel.getDetailsMobileNo(), detailsModel.getDetailsProfession(), detailsModel.getDetailsRoadNo(),
                        detailsModel.getDetailsHoldingNo(), detailsModel.getDetailsHomeAddress(), detailsModel.getDetailsHomeArea());
                dialog.show(getSupportFragmentManager(), "owner_details_fragment");
            }
        });
    ...
    private void initializeImageSlider(String pic1, String pic2, String pic3, String pic4, String pic5) {
        ...
        recyclerViewImage.setAdapter(new ImageSliderAdminAdapter(this, imageUrlLists));
    }
